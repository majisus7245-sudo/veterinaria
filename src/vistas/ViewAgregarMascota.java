...
public class ViewAgregarMascota extends JFrame {
    ...
    private void crearInterfaz() {
        ...
        añadirCampo(tarjeta, gbc, fila, 2, "Raza", txtRaza);
        fila += 2;
        añadirCampo(tarjeta, gbc, fila, 0, "Tipo", txtTipo);
        añadirCampo(tarjeta, gbc, fila, 2, "Sexo", cboSexo);
        fila += 2;
        añadirCampo(tarjeta, gbc, fila, 0, "Edad", txtEdad);
        añadirCampo(tarjeta, gbc, fila, 2, "Peso", txtPeso);
        fila += 2;
        añadirCampo(tarjeta, gbc, fila, 0, "Color", txtColor);
